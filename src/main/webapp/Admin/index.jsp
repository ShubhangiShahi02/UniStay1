							...
							<div class="col-lg-12">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" href="#" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" onclick="login()" value="Log In">
											</div>
										</div>
									</div>
									<div class="form-group">
								...
								<form id="register-form" action="" method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" onclick="register()" value="Register Now">
											</div>
										</div>
									</div>
								</form>
